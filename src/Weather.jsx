...
const Weather = () => {
    ...
    return (
        <div className="h-full w-full max-w-2xl mx-auto p-4 sm:p-6 lg:p-8 bg-gradient-to-br from-blue-400 to-blue-600 rounded-xl shadow-lg">
            <div className="flex flex-col items-center space-y-6">
                <div className="header text-center">
                    <h1 className="text-3xl sm:text-4xl font-bold text-white mb-4">Mountain Weather Forecast</h1>
                </div>
                ...
                {weatherData && (
                    <div className="w-full bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg space-y-4">
